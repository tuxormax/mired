        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              _Frescura(cuando: haceCuanto(red.ultimoEscaneo)),
            ],
          ),
        ),
      ),
...
class _DialogoNuevaRedState extends State<_DialogoNuevaRed> {
  ...
  Future<void> _guardar() async {
    ...
    try {
      // Sin rangos: al darle a "Escanear toda la red", MiRed adopta la red de
      // este equipo. Preguntarlo aqui seria pedir un dato que el programa ya
      // sabe, y encima antes de que haga falta.
      await Api.instancia.crearRed(
          _nombre.text.trim(), _descripcion.text.trim(), const []);
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        'Al terminar podra escanear toda la red con un boton. '
                        'MiRed averigua solo en que red esta este equipo.',
                        style: Theme.of(contexto).textTheme.bodySmall,
                      ),
                    ),
                  ],
...
/// _Frescura dice cuando se escaneo por ultima vez y si eso sigue valiendo.
///
/// El color no es adorno: es lo que permite ver de un vistazo, en una lista de
/// diez sitios, cual lleva semanas sin mirarse.
class _Frescura extends StatelessWidget {
  const _Frescura({required this.cuando});

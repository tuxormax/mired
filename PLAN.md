...
Actualizado el **2026-08-15**, en **v1.19 Rev 31**.
...
Hoy son **19 módulos** → **v1.19**, y la revisión va por la **31**.
...
Más la prueba de humo `herramientas/probar.sh`, con **46 comprobaciones**:
